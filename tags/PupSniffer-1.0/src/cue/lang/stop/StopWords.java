...
public enum StopWords
{
	...
	public static void main(final String[] args)
	{
		...
		//String url = "http://ngramj.sourceforge.net/use_ngramj.html";
		//String url = "http://www.let.rug.nl/~vannoord/TextCat/ShortTexts/dutch.txt";
		url = "http://alias-i.com/lingpipe/demos/tutorial/langid/read-me.html";

		//html = StopWords.fetch(url);
		html = "证券简称,今日开盘价,昨日收盘价,最近成交价,最高成交价,最低成交价,买入价";
		html = "证券简称，今日开盘价，昨日收盘价，最近成交价，最高成交价，最低成交价，买入价";

		//System.out.println(BlockUtil.guessUnicodeBlock(html));
		System.out.println(StopWords.guess(html));
